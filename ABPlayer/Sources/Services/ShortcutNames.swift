...
extension KeyboardShortcuts.Name {
  ...
  static let previousSubtitleSentence = Self(
    "previousSubtitleSentence", default: .init(.leftBracket, modifiers: .option))
  static let nextSubtitleSentence = Self(
    "nextSubtitleSentence", default: .init(.rightBracket, modifiers: .option))
